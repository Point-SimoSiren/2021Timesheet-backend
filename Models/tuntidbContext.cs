...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                //optionsBuilder.UseSqlServer("Server=LAPTOP-UBQPUL3D\\SQLEXSIMOSI;Database=tuntidb;Trusted_Connection=True;");
                optionsBuilder.UseSqlServer("Server = tcp:duuniserver.database.windows.net,1433; Initial Catalog = tuntidb; Persist Security Info = False; User ID = sirensimo; Password = Fullstack7777!; MultipleActiveResultSets = False; Encrypt = True; TrustServerCertificate = False; Connection Timeout = 30;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<WorkAssignment>(entity =>
            {
                ...
                entity.Property(e => e.IdWorkAssignment)
                    .ValueGeneratedOnAdd()
                    .HasColumnName("Id_WorkAssignment");
                ...
                entity.HasOne(d => d.IdWorkAssignmentNavigation)
                    ...
                    .HasForeignKey<WorkAssignment>(d => d.IdWorkAssignment)
